...
public class AttendeeControllerTests
{
    ...
    public async Task GetAllAttendees_WhenAttendeesFound_ReturnsOk()
    {
        ...
        {
            new Attendee { Id = 1, Username = "JohnDoe", Email = "john@example.com", PhoneNumber = "1234567890", Password = "hashedpwd" },
            new Attendee { Id = 2, Username = "JaneDoe", Email = "jane@example.com", PhoneNumber = "9876543210", Password = "hashedpwd" }
        };
        _mockAttendeeService.Setup(service => service.GetAllAttendeesAsync())
    ...
    {
        var attendee = new Attendee { Id = 1, Username = "JohnDoe", Email = "john@example.com", PhoneNumber = "1234567890", Password = "hashedpwd" };
